            ...
            <div className="max-w-5xl w-full grid md:grid-cols-2 gap-12 items-center">
                ...
                >
                    ...
                    <div className="flex gap-6 text-sm">
                        <div className="flex items-center gap-2">
                            ...
                            <span className={theme === 'dark' ? 'text-slate-400' : 'text-slate-600'}>Instant Withdrawal</span>
                        </div>
                        <div className="flex items-center gap-2">
                            <div className="w-2 h-2 bg-[#ffd209] rounded-full" />
                            <span className={theme === 'dark' ? 'text-slate-400' : 'text-slate-600'}>Zero-Knowledge</span>
                        </div>
                    </div>
                </motion.div>
                ...
                >
                    ...
                    <p className={`mt-8 text-center text-xs ${theme === 'dark' ? 'text-slate-500' : 'text-slate-500'
                        ...
                        Protected by Zama FHE Technology. <br />
