            ...
            <div className="max-w-5xl w-full grid md:grid-cols-2 gap-12 items-center">
                ...
                >
                    ...
                    <p className={`mt-8 text-center text-xs ${theme === 'dark' ? 'text-slate-500' : 'text-slate-500'
                        ...
                        By connecting, you agree to ZAMACORPS <a href="#" className="text-[#ffd209] hover:underline">Terms of Service</a> and <a href="#" className="text-[#ffd209] hover:underline">Privacy Policy</a>.
                    </p>
                </motion.div>
            </div>
        </div>
